...
class SnliProcessor(DataProcessor):
    ...
    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self._read_tsv(os.path.join(data_dir, "dev.csv")), "dev_matched")
...
class ImdbProcessor(DataProcessor):
    ...
    def _create_examples(self, lines, set_type):
        ...
        for (i, line) in enumerate(lines):
            ...
            examples.append(InputExample(
                guid=guid, text_a=text_a, text_b=None, label=label))
        print("skip cnt & ratio: ", cnt, '', cnt/len(lines))
...
class YahooProcessor(DataProcessor):
    """Processor for the Yahoo data set ."""
...
class Yelp_fProcessor(DataProcessor):
    """Processor for the Yelp_f data set ."""
...
class News20Processor(DataProcessor):
...
class R8Processor(DataProcessor):
    """Processor for the r8 data set ."""
    ...
    def get_labels(self):
        """See base class."""
        return ['earn', 'acq', 'crude', 'trade', 'money-fx', 'interest', 'ship', 'grain']
...
class R52Processor(DataProcessor):
    """Processor for the r52 data set ."""
...
class CadeProcessor(DataProcessor):
    """Processor for the 20NEWS data set ."""
...
class WebkbProcessor(DataProcessor):
    """Processor for the 20NEWS data set ."""
    ...
    def get_labels(self):
        """See base class."""
        return ['student', 'faculty', 'course', 'project']
...
glue_processors = {
    ...
    "yelp_f": Yelp_fProcessor,
    "news20": News20Processor,
    "r8": R8Processor,
    "r52": R52Processor,
    "cade": CadeProcessor,
    "webkb": WebkbProcessor,
}
...
glue_output_modes = {
    ...
    "yelp_f": "classification",
    "news20": "classification",
    "r8": "classification",
    "r52": "classification",
    "cade": "classification",
    "webkb": "classification",
}
